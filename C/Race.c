...
int main() {
	srand(time(0));
  struct RaceCar Michael_Schumacher = {"Michael Schumacher", "Blue", 5};
  struct RaceCar Fernando_Alonso = {"Fernando Alonso", "Red", 6};
  printIntro();
  printCountDown();
  startRace(&Michael_Schumacher, &Fernando_Alonso);
};
